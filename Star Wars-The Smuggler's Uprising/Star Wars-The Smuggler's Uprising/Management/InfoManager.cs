...
namespace TheGame
{
    class InfoManager
    {
        ...
        {
            info = new string[17];
            info[0] = "\tВы - контрабандист, недавно перевозивший ценный груз Фа'атре Хатту, стоимостью 1 000 000 кредитов.\n" +
            ...
            info[2] = "\tБоковая колода составляется из карт самого игрока. Игрок волен самостоятельно продавать или обменивать карты по всей галактике и оставлять себе те, которые он хотел бы видеть у себя в боковой колоде. Существует два типа карт: Плюс-карты(обычно синего цвета) и Минус-карты(красные). Также есть Улучшенные карты(которые обычно золотого цвета). Карты главной колоды — зелёные, а в старых наборах для игры — золотистые.\n" +
            ...
            info[3] = "\tГробницы Коррибана - место погребения величайших лордов ситхов, таких, как Марка Рагнос, Аджанта Полл, Нага Садоу, Тулак Хорд и ряда других.\n" +
            ...
            info[4] = "\tРакатанские руины на Дантуине были разрушенным ракатанским храмом «Звёздной кузницы», сооружённом около 30000 ДБЯ в эпоху наивысшего расцвета Бесконечной Империи.\n\t" +
            ...
            info[5] = "\tАнклав джедаев, располагавшийся на планете Дантуин, был академией Ордена джедаев. Как и в Храме на Корусанте, юные ученики-джедаи обучались здесь путям Силы. Анклав имел собственный совет, состоявший из четырёх членов и подчинявшийся Высшему Совету на Корусанте.\n" +
                "\n\tЗдесь Вы можете рассчитывать на защиту Ордена джедаев в случае наличия 15 000 очков мудрости. Очки мудрости можно получить, сдавая предметы, выкопанные в древних руинах. Стоимости всех предметов:\n" +
            ...
            info[6] = "\tАкадемия ситхов на Коррибане была центром Империи ситхов в течении Гражданской войны джедаев, направленной на тренировки чувствительных к Силе, которые решили встать на путь Тёмной стороны, чтобы в дальнейшем отправляться на поиски древних артефактов и знаний в Долину Тёмных лордов и стать мастерами.\n" +
                "\n\tЗдесь Вы можете рассчитывать на защиту Ордена ситхов в случае наличия 15 000 очков престижа. Очки престижа можно получить, сдавая предметы, выкопанные в древней гробнице. Стоимости всех предметов:\n" +
